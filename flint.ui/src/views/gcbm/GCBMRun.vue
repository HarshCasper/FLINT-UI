...
export default {
  ...
  methods: {
    runSim: function () {
      ...
      axios
        .post('https://gcbm.azurewebsites.net/gcbm/dynamic', bodyFormData)
        .then((response) => {
    ...
    checkStatus: function () {
      ...
      axios
        .post('https://gcbm.azurewebsites.net/gcbm/status', bodyFormData)
        .then((response) => {
    ...
    downloadSim: function () {
      ...
      axios
        .post('https://gcbm.azurewebsites.net/gcbm/download', bodyFormData, {
